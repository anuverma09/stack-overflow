    ...
    <div className="card-wrapper rounded-[10px] p-9 sm:px-11">
      <div className="flex flex-col-reverse items-start justify-between gap-5 sm:flex-row">
        <div>
          ...
          <Link href={`/question/${_id}`}>// </Link>{" "}
          <Link href={`http://localhost:3000/question/${_id}`}>
        ...
        {/* if signin then delete facility */}
        <SignedIn>
          {showActionButtons && (
      ...
      <div className="flex-between mt-6 w-full flex-wrap gap-3">
        <Metric
          //   imgUrl="/public/assets/icons/like.svg"
        ...
        <div className="flex items-center gap-3 max-sm:flex-wrap max-sm:justify-start">
          ...
          <Metric
            //   imgUrl="/public/assets/icons/message.svg"
            imgUrl={messagepic}
            alt="message"
          ...
          <Metric
            //   imgUrl="/public/assets/icons/eye.svg"
            imgUrl={eyepic}
            alt="eye"
